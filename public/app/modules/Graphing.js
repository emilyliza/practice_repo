...
// 	.directive('bars', ['$window', '$http', '$filter', '$timeout', '$state', 'ReportingService',
// 		function($window, $http, $filter, $timeout, $state, ReportingService) {
...
//                   .attr("class", "label")
//                   .attr("x", function(d) {
//                       return x(d.name) + (x.rangeBand() / 3) - 5;
//                   })
//                   .attr("y", function(d) {
//                       return y(d.count) + 40;
//                   })
//                   .text(function(d) {
//                       return (d.count * 100).toFixed() + "%";
//                   });
//       };
